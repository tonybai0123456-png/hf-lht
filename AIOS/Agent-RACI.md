...
| 生产故障或技术安全事件 | A | I | I | I | C | R | C | I | 必须立即人工升级；Agent 不自行发布修复 |
...
- 跨 Agent 事项仍必须指定一个专业 Agent 为 R，不能只写“CEO Agent 跟进”。
...
| 生产中断、支付或订单错误 | Developer/Shopify | CEO Agent | 立即升级人工负责人；禁止自行发布 |
