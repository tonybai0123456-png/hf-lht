...
| 7 | TG-01 | Thread Governance v2.0（线程治理第 2.0 版） | BUW AIOS Official Governance Thread | [Issue #11](https://github.com/tonybai0123456-png/hf-lht/issues/11) / branch `agent/aios-thread-governance-v1` / [Draft PR #12](https://github.com/tonybai0123456-png/hf-lht/pull/12) | Reviewed | Governance Thread accepted the Stage 7 technical result and approved the v2.0 migration update. | Keep Draft; v2.0 publication, merge and archival require separate governance decisions. Project Governance Baseline remains an unassigned backlog item in [Issue #13](https://github.com/tonybai0123456-png/hf-lht/issues/13) and is not part of TG-01. Stage 8 remains Planned. |
