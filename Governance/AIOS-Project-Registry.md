...
|---|---|---|---|---|---|---|---|---|---|---|---|
| BUW-AIOS | BUW AIOS | 汇沣电商; the company is not collapsed into this project; 六合通 is a separate company and excluded | BUW only; PC is an independent brand and excluded | Tony | BUW AIOS Official Governance Thread | `tonybai0123456-png/hf-lht` | `Governance/AIOS-Project-Governance-Baseline-v1.md` / `Governance/AIOS-Stage-Registry.md` | Active | No active Execution Stage / Stage 12 Archived / Stage 13 Planned | 2026-07-22 / PR #29 published at `454a719` / validator PASS / 11/11 targeted and 61/61 repository tests / Schema and compilation PASS | Stage 13 remains unassigned and may start only through a separate Governance Thread decision; legal approval, real data, production, owner assignment, risk acceptance, pilot and release remain unauthorized |
