...
|---|---|---|---|---|---|---|---|---|---|---|---|
| BUW-AIOS | BUW AIOS | 汇沣电商; 六合通 is a separate company and excluded | BUW only; PC is an independent brand and excluded | Tony | BUW AIOS Official Governance Thread | `tonybai0123456-png/hf-lht` | `Governance/AIOS-Project-Governance-Baseline-v1.md` / `Governance/AIOS-Stage-Registry.md` | Active | Stage 13 Archived / Stage 14 Reported | 2026-07-23 / Issue #36 / implementation evidence head `d0fac2e21266c6d9a815f121a409436bea166ebf` / Draft PR #37 / 11 focused / 92 repository / 9 Project Governance tests / `needs_human_governance` / Mandatory Return | Awaiting independent human review under independently approved plan exact head `7c086bbaa1d65715a884b0a803958410bdf272a7`; no pilot authority, merge, publication, release or archive authority |
