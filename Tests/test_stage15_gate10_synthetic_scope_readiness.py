...
class Stage15Gate10SyntheticScopeReadinessTests(unittest.TestCase):
    def test_gate10_scope_is_decision_ready_but_not_approved(self):
        ...
        self.assertIs(False, audit["gate10_decision_boundary"]["gate_accepted"])
        ...
        self.assertIs(False, gate10["accepted"])
        self.assertEqual(
            "proposed_awaiting_explicit_owner_approval", gate10["state"]
        )
        ...
        self.assertIs(False, candidate["gate_ledger"][9]["accepted"])
        self.assertEqual(
            "proposed_awaiting_explicit_owner_approval",
            candidate["gate_ledger"][9]["state"],
        )
        ...
        self.assertEqual(
            "ready_for_explicit_owner_decision_not_approved", result["result"]
        )
    ...
    def test_evaluation_is_deterministic_and_does_not_mutate_inputs(self):
        ...
        self.assertEqual(
            "ready_for_explicit_owner_decision_not_approved", first["result"]
        )
        self.assertIs(False, first["gate10_accepted"])
    ...
    def test_boundary_drift_and_premature_authority_fail_closed(self):
        ...
        premature_proposal_approval = copy.deepcopy(proposals)
        premature_proposal_approval["proposals"][3]["accepted"] = True
        premature_proposal_approval["proposals"][3]["state"] = "accepted"

        premature_candidate_approval = copy.deepcopy(candidate)
        premature_candidate_approval["gate_ledger"][9]["accepted"] = True
        premature_candidate_approval["gate_ledger"][9]["state"] = "accepted"
        ...
        attacks = (
            ...
            (audit, gate9, premature_proposal_approval, candidate, fixture),
            (audit, gate9, proposals, premature_candidate_approval, fixture),
    ...
    def test_cli_reports_decision_ready_not_approved(self):
        ...
        self.assertIn("gate10_accepted=false", completed.stdout)
